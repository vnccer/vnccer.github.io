...
![](images/ET-BERT架构.png "ET-BERT框架")
...
## 4.2 与最先进方法(SOTA)的对比
![](images/不同数据集的结果对比.png "不同数据集的结果对比")

![](images/不同数据集的结果对比2.png "不同数据集的结果对比2")
...
## 4.3 消融实验
![](images/消融实验.png "ET-BERT关键组件在ISCX-VPN-App数据集上的消融实验")
...
![](images/密码算法随机性结果.png "密码算法随机性结果")

### 4.4.2 密码算法的影响
![](images/不同数据集的密码算法使用情况.png "不同数据集的密码算法使用情况")
